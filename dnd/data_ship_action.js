data_ship_action = [
    {
        ...
        bullets: [
            ...
            "You may target a spelljammer, a weapon onboard a spelljammer, the crew of a spelljammer, or creatures on board the spelljammer."
        ]
    },
    {
        title: "Board",
        icon: "grab",
        subtitle: "When within 5 ft. of another ship",
        description: "Enable safe movement of characters between ships, when within 5 feet of another ship",
        reference: "AAG, pg. 25",
        bullets: [
            "When one ship moves to within 5 feet of another ship, the Pilot of the moving ship can maneuver it alongside the other ship, enabling creatures to move safely from one ship’s deck to the other ship’s deck until one of the ships pulls away from the other.",
