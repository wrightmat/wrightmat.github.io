data_officer_action = [
    {
        ...
        subtitle: "Increase ship's Agility by 50%",
        description: "Agility cost becomes 1 degree per 2 degrees turned",
        reference: "",
        bullets: [
            "As an action, you can increase the ship’s agility by 50% until the end of its next turn, allowing the ship to rotate further than normal.",
            "The ship can only benefit from one bonus to its agility at a time.",
        ]
    },
    {
    ...
    },
    {
        ...
        subtitle: "Grant an officer an extra action",
        description: "Grant an officer an extra action",
        reference: "",
        bullets: [
            "You can attempt a Charisma (Intimidation) check to frighten or redirect a non-spelljammer crew member to act more quickly, granting them an extra action. The DC is 12 plus the crew member’s level (more powerful crew members are more difficult to intimidate)."
        ]
    },
    {
    ...
    },
    {
        ...
        description: "Infuse the ship with magic to increase AC, Speed, or Agility",
        reference: "",
        bullets: [
            ...
            "Reaction Control. Until the start of its next turn, the ship gains a bonus to its agility equal to 50% + 50% per spell level above first."
        ]
    },
    {
    ...
    },
    {
        ...
        reference: "",
        bullets: [
            "As an action, you hastily tend to the injuries of another officer within 5 feet of you. The bandages may not hold up in the long term, but they will help for now. If the officer is at 0 hit points, it becomes stable. Otherwise, the officer gains temporary hit points equal to 1d6 + your Wisdom modifier."
        ]
    }
]