data_officer_position = [
    {
        ...
        bullets: [
            "The Pilot is a spellcaster who uses their magic to propel and steer the spelljamming vessel. Without a Pilot attuned to the helm of the spelljamming ship, it cannot move. Therefore, the Pilot role is the most important role on a spelljammer and is to be protected at all costs.",
    ...
    },
    {
        ...
        bullets: [
            "The Navigator assists the Pilot and ensures that the ship is moving and operating most effectively. The Navigator role is entirely optional, but is usually a good fit for something with high Intelligence.",
    ...
    },
    {
        ...
        bullets: [
            "An Engineer takes on the duties of repairing and maintaining the ship. The Engineer role is usually a good fit for someone with high Strength or Dexterity, and can benefit from a spellcaster with the <i>mending</i> cantrip.",
            "During your turn and while aboard a friendly spelljammer, you have access to the following special options in addition to your normal options and abilities:"
        ],
	actions: [
	    "Brace For Impact",
    ...
    },
    {
        ...
        bullets: [
            "The Magic Officer assists the crew in much the same way as the Pilot, except they aren’t attuned to the helm and therefore can’t control the ship. The Magic Officer role is entirely optional, but is usually a good fit if there’s an extra spellcaster.",
            "During your turn and while aboard a friendly spelljammer, you have access to the following special options in addition to your normal options and abilities:"
        ],
	actions: [
	    "Augment Weapon",
    ...
    },
    {
        ...
        icon: "shining-heart",
        subtitle: "Motivate and support the crew and officers",
        description: "Motivate and support the crew and officers",
        bullets: [
            "A Morale Officer takes on the duties of motivating the crew, and often also takes on the role of a ship’s cook or therapist. The Morale Officer role is optional, but is usually a good fit for someone with high Charisma and Wisdom.",
            "During your turn and while aboard a friendly spelljammer, you have access to the following special options in addition to your normal options and abilities:"
        ],
	actions: [
	    "Full Speed Ahead",
