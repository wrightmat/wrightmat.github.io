...
A future step type follows the identical rule: everything it needs lives on ITS OWN entry, so supporting a new System's own build-wizard shape is a data change, never a JS change.
