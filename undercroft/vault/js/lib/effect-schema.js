...
// Stamps a freshly generated effect (from generator.js) with an id +
// timestamp so it's ready to save — kept separate from generateEffect itself
...
export function createEffectRecord(generated) {
  return {
    id: `eff_${randomId()}`,
    ...generated,
...
// The saved effect record is already Press-compatible (flat, JSON-
