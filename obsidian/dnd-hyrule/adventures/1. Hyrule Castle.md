...
The first room serves as the home of the Master Sword, where it sits on display. There is nothing much else of interest here, and if anything is touched then guards will yell.
...
Attempting a combat-based solution will result in the guard sounding the alarm, causing a deadly encounter. Include this guard as a **Hylian Soldier/Cleric** (CR 1/4) as well as 1d10 additional solders/clerics.
...
`encounter: 1: Hylian Soldier, 1d10: Hylian Soldier`
...
After defeat, the Captain reward the team with a **Magnetic Glove**.
...
- Players choose one: **Life Medal** or **Treasure Medal**
- `dice: 4d6*10` rupees
